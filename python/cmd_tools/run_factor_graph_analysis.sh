...
for dir_name in ${eval_set[@]}; do
    python ../factor_graph_insights/app.py -d $data_folder/$dir_name/factor_graphs/mono/lba/ -s 0 -e 30 --loglevel info --near_depth_threshold 0.25 --far_depth_threshold 2
done
